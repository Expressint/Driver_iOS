...
//            }
            ...
            if pageNO == 1
            {
                ...
                self.setCornertoView(View: viewTwo, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: lblTwo)
                self.setCornertoView(View: viewThree, BGColor: UIColor.white, borderColor: themeGrayTextColor, textcolor: themeGrayTextColor, label: lblThree)
                self.setCornertoView(View: viewFore, BGColor: UIColor.white, borderColor: themeGrayTextColor, textcolor: themeGrayTextColor, label: lblFore)
                self.setCornertoView(View: viewFifth, BGColor: UIColor.white, borderColor: themeGrayTextColor, textcolor: themeGrayTextColor, label: lblFifth)
                viewOneTwoLine.backgroundColor = ThemeAppMainColor
                viewTwoThreeLine.backgroundColor = themeGrayTextColor
                viewThreeForeLine.backgroundColor = themeGrayTextColor
                viewFourFifthLine.backgroundColor = themeGrayTextColor
            }
            else if pageNO == 2
            {
                self.setCornertoView(View: viewOne, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: lblone)
                self.setCornertoView(View: viewTwo, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: lblTwo)
                self.setCornertoView(View: viewThree, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: lblThree)
                self.setCornertoView(View: viewFore, BGColor: UIColor.white, borderColor: themeGrayTextColor, textcolor: themeGrayTextColor, label: lblFore)
                self.setCornertoView(View: viewFifth, BGColor: UIColor.white, borderColor: themeGrayTextColor, textcolor: themeGrayTextColor, label: lblFifth)
                viewOneTwoLine.backgroundColor = ThemeAppMainColor
                viewTwoThreeLine.backgroundColor = ThemeAppMainColor
                viewThreeForeLine.backgroundColor = themeGrayTextColor
                viewFourFifthLine.backgroundColor = themeGrayTextColor
            }
            else if pageNO == 3
            {
                ...
                self.setCornertoView(View: viewTwo, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: lblTwo)
                self.setCornertoView(View: viewThree, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: lblThree)
                self.setCornertoView(View: viewFore, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: lblFore)
                self.setCornertoView(View: viewFifth, BGColor: UIColor.white, borderColor: themeGrayTextColor, textcolor: themeGrayTextColor, label: lblFifth)
                viewOneTwoLine.backgroundColor = ThemeAppMainColor
                viewTwoThreeLine.backgroundColor = ThemeAppMainColor
                viewThreeForeLine.backgroundColor = ThemeAppMainColor
                viewFourFifthLine.backgroundColor = themeGrayTextColor
            }
            else if pageNO == 4
            {
                ...
                self.setCornertoView(View: viewThree, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: lblThree)
                self.setCornertoView(View: viewFore, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: lblFore)
                self.setCornertoView(View: viewFifth, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: lblFifth)
                viewOneTwoLine.backgroundColor = ThemeAppMainColor
                viewTwoThreeLine.backgroundColor = ThemeAppMainColor
                viewThreeForeLine.backgroundColor = ThemeAppMainColor
                viewFourFifthLine.backgroundColor = ThemeAppMainColor
            }
//            else if pageNO == 5
//            {
//
...
//
        ...
        else
        {
            ...
            {
                self.setCornertoView(View: driverVC.viewOne, BGColor: ThemeAppMainColor, borderColor: ThemeAppMainColor, textcolor: UIColor.white, label: driverVC.lblone)
...
//            lblTitle.text = "Tan Taxi"
            lblTitle.textColor = ThemeAppMainColor
...
//            lblTitle.text = "Re"
        ...
        self.navigationController?.navigationBar.tintColor = ThemeAppMainColor
        self.navigationController?.navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor : ThemeAppMainColor]
...
//                }
                ...
                personalVC.txtDistrict.text = UserDefaults.standard.value(forKey: RegistrationFinalKeys.kDistrict) as? String
