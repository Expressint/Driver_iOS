...
class Snackbar: NSObject {
    ...
    var textColor: UIColor          = ThemeAppMainColor //UIColor(red: 204/255, green: 3/255, blue: 0/255, alpha: 1.0)
    var buttonColor:UIColor         = ThemeAppMainColor //UIColor(red: 204/255, green: 3/255, blue: 0/255, alpha: 1.0)
