...
class MyJobsViewController: ParentViewController
{
    ...
    @IBAction func btnPendingJobsClicked(_ sender: Any)
    {
        ...
        UIView.animate(withDuration: 0.5, delay: 0.0, options: .curveEaseOut, animations: {
            ...
            //            let PendingJobsList = ((((self.navigationController?.children[0] as! TabbarController).children.last)as! MyJobsViewController).children[1])as! PendingJobsListVC
            //
    ...
    func callSocket() {
        ...
        //        let socket = (((self.navigationController?.children[0] as! TabbarController).children)[0] as! ContentViewController).socket
        
        
        let socket = (UIApplication.shared.delegate as! AppDelegate).SManager.defaultSocket
        //
        //        var isAdvance = (((self.navigationController?.children[0] as! TabbarController).children)[0] as! HomeViewController).isAdvanceBooking
        //        isAdvance = true
        
        
        //        let ttabbar = (self.navigationController?.children[0] as! TabbarController)
