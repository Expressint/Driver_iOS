...
//        imgLKR.tintColor = UIColor.gray
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.lblAvailableFundsDesc.textColor = ThemeAppMainColor
...
//        }
        if dictData["Status"] as! String == "failed" {
            ...
            cell.lblPrice.textColor = ThemeAppMainColor//UIColor.init(red: 204/255, green: 3/255, blue: 0, alpha: 1.0)
            
            cell.statusHeight.constant = 20.5
            cell.lblStatus.isHidden = false
            cell.lblStatus.text = "Transaction Failed"
            cell.lblStatus.textColor = ThemeAppMainColor//UIColor.init(red: 204/255, green: 3/255, blue: 0, alpha: 1.0)
        }
...
//    }
    ...
    @IBAction func btnTopUP(_ sender: UIButton) {
        ...
        self.lblTopUp.textColor = ThemeAppMainColor
    ...
    @IBAction func btnHistory(_ sender: UIButton) {
        ...
        self.lblHistory.textColor = ThemeAppMainColor
