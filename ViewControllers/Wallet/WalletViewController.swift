...
//        ((((self.navigationController?.children[1]) as! CustomSideMenuViewController).children[0] as! UINavigationController).children[0] as! TabbarController).children[0] as! ContentViewController)
        
        let tabbarVC = ((self.navigationController as! UINavigationController).viewControllers[1] as! CustomSideMenuViewController)//.children[0]) as! UINavigationController).viewControllers[0] as! TabbarController
