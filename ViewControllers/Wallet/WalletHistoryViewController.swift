...
//        }
        if dictData["Status"] as! String == "failed" {
            ...
            cell.lblAmount.textColor = ThemeAppMainColor //UIColor.init(red: 204/255, green: 3/255, blue: 0, alpha: 1.0)//
            ...
            cell.lblTransferStatus.textColor = ThemeAppMainColor //UIColor.init(red: 204/255, green: 3/255, blue: 0, alpha: 1.0)
        }
