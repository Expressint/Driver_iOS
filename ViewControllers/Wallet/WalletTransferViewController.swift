...
//        f = false
        ...
        self.lblSendMoney.textColor = ThemeAppMainColor
...
//        viewEnterMoney.isHidden = true
        ...
        self.lblReceiveMoney.textColor = ThemeAppMainColor
    ...
    @IBAction func btnSendBankAccount(_ sender: UIButton) {
        ...
        self.lblTransferToBank.textColor = ThemeAppMainColor
        ...
        webserviceForASendMoneyInWallet(dictParam as AnyObject) { (result, status) in
            ...
            if (status) {
                ...
                if let res = result as? String {
                    ...
                    UtilityClass.showAlert(appName.kAPPName, message: resDict.object(forKey: GetResponseMessageKey()) as! String, vc: self)
                }
                else if let resAry = result as? NSArray {
                    UtilityClass.showAlert(appName.kAPPName, message: (resAry.object(at: 0) as! NSDictionary).object(forKey: GetResponseMessageKey()) as! String, vc: self)
                }
